...
const goods2 = { name: 'TV', price: 1000, countSold: 2};
const goods3 = { name: 'TV', price: 1000 }

const printGoods = ({name, price, countStock = 0, countSold = 0}) => console.log(name, price, countSold, countStock);
